...
INSERT INTO "new_User" ("active", "createdAt", "deactivationDate", "email", "emailVerified", "firstName", "id", "image", "lastName", "name", "netID", "responsibilities", "role", "updatedAt") SELECT "active", "createdAt", "deactivationDate", "email", "emailVerified", "firstName", "id", "image", "lastName", "name", "netID", "responsibilities", "role", "updatedAt" FROM "User";
DROP TABLE "User";
